...
unsigned char decodeKey() {
	...
	static unsigned char shiftKeys[11][8] = { { 0x7f, 0x0d, 0x04, 0x00, 0x00,
			...
			'%', 'R', 'D', '&', 'C', 'F', 'T', 'X' }, { '\'', 'Y', 'G', '(',
			'B', 'H', 'U', 'V' }, { ')', 'I', 'J', '0', 'M', 'K', 'O', 'N' }, {
			'+', 'P', 'L', '-', '>', '[', '@', '<' }, { '\\', '*', ']', 0x00,
			0x00, '=', '^', '?' },
			{ '!', 0x00, 0x00, '"', 0x20, 0x00, 'Q', 0x00 }, { 0x00, '8', '5',
					0x09, '2', '4', '7', '1' }, { 0x1b, '+', '-', 0x0a, 0x0d,
					'6', '9', '3' }, { 0x00, '0', '.', 0x05, 0x18, 0x13, 0x04,
					0x00 } };
	unsigned char i = 0;
	unsigned char keyCode = 0x00;
	unsigned char lsCol, rsCol, col;
